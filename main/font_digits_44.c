...
#ifndef FONT_DIGITS_44
#define FONT_DIGITS_44 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 543, .adv_w = 270, .box_w = 13, .box_h = 4, .ofs_x = 2, .ofs_y = 10},
    {.bitmap_index = 569, .adv_w = 160, .box_w = 6, .box_h = 7, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 590, .adv_w = 470, .box_w = 26, .box_h = 31, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 993, .adv_w = 260, .box_w = 12, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1179, .adv_w = 404, .box_w = 24, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1551, .adv_w = 403, .box_w = 24, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1923, .adv_w = 471, .box_w = 28, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2357, .adv_w = 404, .box_w = 24, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2729, .adv_w = 434, .box_w = 24, .box_h = 31, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 3101, .adv_w = 421, .box_w = 24, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3473, .adv_w = 453, .box_w = 26, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3876, .adv_w = 434, .box_w = 25, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4264, .adv_w = 160, .box_w = 6, .box_h = 24, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4336, .adv_w = 533, .box_w = 28, .box_h = 31, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 4770, .adv_w = 506, .box_w = 28, .box_h = 31, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5204, .adv_w = 672, .box_w = 34, .box_h = 31, .ofs_x = 4, .ofs_y = 0}
};
...
static const uint16_t unicode_list_0[] = {
    ...
    0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x1d, 0x26,
    0x28
};
...
{
    {
        .range_start = 37, .range_length = 41, .glyph_id_start = 1,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_digits_44 = {
#else
lv_font_t font_digits_44 = {
#endif
